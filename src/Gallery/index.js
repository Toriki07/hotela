...
class gallery extends Component {
  render() {
    return (
      ...
      <div className="gallery app-pages app-section">
        <div className="container">
          ...
          <div className="row">
            <div className="col s6">
              <a href="img/gallery1.jpg" data-lightbox="image-1">
                <img src="img/gallery1.jpg" alt=""/>
              </a>
            </div>
            <div className="col s6">
              <a href="img/gallery2.jpg" data-lightbox="image-1">
          ...
          <div className="row">
            <div className="col s6">
              <a href="img/gallery3.jpg" data-lightbox="image-1">
                <img src="img/gallery3.jpg" alt=""/>
              </a>
            </div>
            <div className="col s6">
              <a href="img/gallery4.jpg" data-lightbox="image-1">
          ...
          <div className="row">
            <div className="col s6">
              <a href="img/gallery5.jpg" data-lightbox="image-1">
                <img src="img/gallery5.jpg" alt=""/>
              </a>
            </div>
            <div className="col s6">
              <a href="img/gallery6.jpg" data-lightbox="image-1">
